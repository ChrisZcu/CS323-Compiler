...
{
       0,    38,    38,    46,    49,    53,    56,    59,    63,    66,
      71,    74,    79,    83,    88,    91,    96,    99,   103,   106,
     110,   115,   119,   122,   126,   129,   132,   135,   138,   141,
     146,   149,   154,   159,   162,   167,   170,   175,   176,   177,
...
#line 38 "syntax.y" /* yacc.c:1646  */
    {
        ...
        int i = (yylsp[0]).first_line; //BUG 排除行
        if (!has_error) {
            parsetree((yyval.ast), 0);
        }
    }
...
#line 189 "syntax.y" /* yacc.c:1646  */
    {(yyval.ast) = new_ast("Exp", 2, (yyvsp[-1].ast));}
